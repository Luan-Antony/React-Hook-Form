            ...
            <form className="form" onSubmit={handleSubmit(handleSubmitForm)}>
                ...
                <input
                    ...
                    className={`campo ${errors.nome ? "campo-obrigatorio" : ""} 
                                ${touchedFields.nome && !errors.nome ? "campo-preenchido" : ""}`}
                ...
                <input
                    ...
                    id="email"
                    placeholder=" Email *"
                    className={`campo ${errors.email ? "campo-obrigatorio" : ""}
                                ${touchedFields.email && !errors.email ? "campo-preenchido" : ""}`}
                ...
                <input
                    ...
                    className={`campo ${errors.telefone ? "campo-obrigatorio" : ""} 
                                ${touchedFields.telefone && !errors.telefone ? "campo-preenchido" : ""}`}
